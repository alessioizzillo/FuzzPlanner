...
cp "${SCRIPT_DIR}/network.sh" "${WORK_DIR}/image_backup/firmadyne/network.sh"
chmod a+x "${IMAGE_DIR}/firmadyne/network.sh"
chmod a+x "${WORK_DIR}/image_backup/firmadyne/network.sh"

cp "${SCRIPT_DIR}/run_service.sh" "${IMAGE_DIR}/firmadyne/run_service.sh"
cp "${SCRIPT_DIR}/run_service.sh" "${WORK_DIR}/image_backup/firmadyne/run_service.sh"
chmod a+x "${IMAGE_DIR}/firmadyne/run_service.sh"
chmod a+x "${WORK_DIR}/image_backup/firmadyne/run_service.sh"

cp "${SCRIPT_DIR}/injectionChecker.sh" "${IMAGE_DIR}/bin/a"
chmod a+x "${IMAGE_DIR}/bin/a"

touch "${IMAGE_DIR}/firmadyne/debug.sh"
touch "${WORK_DIR}/image_backup/firmadyne/debug.sh"
chmod a+x "${IMAGE_DIR}/firmadyne/debug.sh"
chmod a+x "${WORK_DIR}/image_backup/firmadyne/debug.sh"
