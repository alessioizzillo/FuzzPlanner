graph [
  ...
  edge [
    ...
    target 2
    key 8
    edge_name "file{path:/etc/usertty}"
    score 0.0
  ]
  edge [
    source 8
  ...
  edge [
    ...
    target 22
    key 11
    edge_name "socket(domain:2, type:1, protocol:0){addr:127.0.0.1; port:44677}"
    score 1.0
  ]
  edge [
    source 8
    target 22
    key 12
    edge_name "socket(domain:10, type:1, protocol:0){addr:0.0.0.0; port:54709}"
    score 1.0
  ]
  edge [
    source 8
    target 22
    key 13
    edge_name "socket(domain:2, type:1, protocol:0){addr:127.0.0.1; port:55491}"
    score 1.0
  ]
  edge [
    source 8
    target 22
    key 14
    edge_name "socket(domain:10, type:1, protocol:0){addr:0.0.0.0; port:41797}"
    score 1.0
  ]
  edge [
    source 8
    target 22
    key 15
    edge_name "socket(domain:2, type:1, protocol:0){addr:127.0.0.1; port:39380}"
    score 1.0
  ]
  edge [
    source 8
    target 22
    key 16
    edge_name "socket(domain:10, type:1, protocol:0){addr:0.0.0.0; port:49306}"
    score 1.0
  ]
  edge [
    source 8
    target 22
    key 17
    edge_name "socket(domain:2, type:1, protocol:0){addr:127.0.0.1; port:33241}"
    score 1.0
  ]
  edge [
    source 8
    target 22
    key 18
    edge_name "socket(domain:10, type:1, protocol:0){addr:0.0.0.0; port:49703}"
    score 1.0
  ]
  edge [
    source 8
    target 22
    key 19
    edge_name "socket(domain:2, type:1, protocol:0){addr:127.0.0.1; port:57081}"
    score 1.0
  ]
  edge [
    source 8
    target 22
    key 20
    edge_name "socket(domain:10, type:1, protocol:0){addr:0.0.0.0; port:41653}"
    score 1.0
  ]
  edge [
    source 8
    target 22
    key 21
    edge_name "socket(domain:2, type:1, protocol:0){addr:127.0.0.1; port:48384}"
    score 1.0
  ]
  edge [
    source 8
    target 22
    key 22
    edge_name "socket(domain:10, type:1, protocol:0){addr:0.0.0.0; port:47801}"
    score 1.0
  ]
  edge [
    source 8
  ...
  edge [
    ...
    target 24
    key 4
    edge_name "socket(domain:2, type:1, protocol:0){addr:192.168.1.2; port:36841}"
    score 1.0
  ]
  edge [
    source 8
    target 24
    key 5
    edge_name "socket(domain:2, type:1, protocol:0){addr:192.168.1.2; port:37739}"
    score 1.0
  ]
  edge [
    source 8
  ...
  edge [
    ...
    target 31
    key 0
    edge_name "socket(domain:2, type:2, protocol:0){addr:0.0.0.0; port:23}"
    score 1.0
  ]
  edge [
    source 8
    target 32
    key 0
    edge_name "file{path:/etc/protocols}"
    score 0.0
  ]
  edge [
    source 8
    target 32
    key 1
    edge_name "socket(domain:2, type:3, protocol:1){addr:192.168.1.1; port:0}"
    score 1.0
  ]
  edge [
    source 8
    target 33
    key 0
    edge_name "virtual_file{path:/proc/net/tcp}"
    score 0.15
  ]
  edge [
    source 8
    target 33
    key 1
    edge_name "virtual_file{path:/proc/net/tcp6}"
    score 0.15
  ]
  edge [
    source 8
    target 33
    key 2
    edge_name "virtual_file{path:/proc/net/udp}"
    score 0.15
  ]
  edge [
    source 8
    target 33
    key 3
    edge_name "virtual_file{path:/proc/net/udp6}"
    score 0.15
  ]
  edge [
    source 8
    target 33
    key 4
    edge_name "virtual_file{path:/proc/net/raw}"
    score 0.15
  ]
  edge [
    source 8
    target 33
    key 5
    edge_name "virtual_file{path:/proc/net/raw6}"
    score 0.15
  ]
  edge [
    source 8
    target 33
    key 6
    edge_name "virtual_file{path:/proc/net/unix}"
    score 0.15
  ]
  edge [
    source 14
